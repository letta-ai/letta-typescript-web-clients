...
export const listComposioActionsByAppSuspenseQueryKey = (composio_app_name: ListComposioActionsByAppPathParams['composio_app_name']) =>
  [{ url: '/v1/tools/composio/apps/:composio_app_name/actions', params: { composio_app_name: composio_app_name } }] as const

export type ListComposioActionsByAppSuspenseQueryKey = ReturnType<typeof listComposioActionsByAppSuspenseQueryKey>
...
>(
  ...
  options: {
    query?: Partial<
      UseSuspenseQueryOptions<ResponseConfig<ListComposioActionsByAppQueryResponse>, ResponseErrorConfig<ListComposioActionsByApp422>, TData, TQueryKey>
    > & { client?: QueryClient }
    client?: Partial<RequestConfig> & { client?: typeof client }
  } = {},
) {
  const { query: { client: queryClient, ...queryOptions } = {}, client: config = {} } = options ?? {}
  const queryKey = queryOptions?.queryKey ?? listComposioActionsByAppSuspenseQueryKey(composio_app_name)

  const query = useSuspenseQuery(
    {
      ...(listComposioActionsByAppSuspenseQueryOptions(composio_app_name, config) as unknown as UseSuspenseQueryOptions),
      queryKey,
      ...(queryOptions as unknown as Omit<UseSuspenseQueryOptions, 'queryKey'>),
    },
    queryClient,
  ) as UseSuspenseQueryResult<TData, ResponseErrorConfig<ListComposioActionsByApp422>> & { queryKey: TQueryKey }
