...
export const agentsMigrateAgentMutationKey = () => [{ url: '/v1/agents/{agent_id}/migrate' }] as const

export type AgentsMigrateAgentMutationKey = ReturnType<typeof agentsMigrateAgentMutationKey>
...
export async function agentsMigrateAgent(
  ...
  config: Partial<RequestConfig<AgentsMigrateAgentMutationRequest>> & { client?: typeof client } = {},
) {
  const { client: request = client, ...requestConfig } = config

  const res = await request<
    AgentsMigrateAgentMutationResponse,
    ResponseErrorConfig<AgentsMigrateAgent404 | AgentsMigrateAgent409 | AgentsMigrateAgent500>,
    AgentsMigrateAgentMutationRequest
  >({ method: 'POST', url: `/v1/agents/${agent_id}/migrate`, data, ...requestConfig })
  return res
}
...
export function useAgentsMigrateAgent<TContext>(
  options: {
    mutation?: UseMutationOptions<
      ...
      ResponseErrorConfig<AgentsMigrateAgent404 | AgentsMigrateAgent409 | AgentsMigrateAgent500>,
      { agent_id: AgentsMigrateAgentPathParams['agent_id']; data: AgentsMigrateAgentMutationRequest },
      TContext
    > & { client?: QueryClient }
    client?: Partial<RequestConfig<AgentsMigrateAgentMutationRequest>> & { client?: typeof client }
  } = {},
) {
