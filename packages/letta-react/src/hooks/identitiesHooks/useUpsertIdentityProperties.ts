...
export const upsertIdentityPropertiesMutationKey = () => [{ url: '/v1/identities/{identity_id}/properties' }] as const

export type UpsertIdentityPropertiesMutationKey = ReturnType<typeof upsertIdentityPropertiesMutationKey>
...
export async function upsertIdentityProperties(
  ...
  config: Partial<RequestConfig<UpsertIdentityPropertiesMutationRequest>> & { client?: typeof client } = {},
) {
  ...
  const res = await request<
    ...
    UpsertIdentityPropertiesMutationRequest
  >({ method: 'PUT', url: `/v1/identities/${identity_id}/properties`, data, ...requestConfig })
  return res
}
...
export function useUpsertIdentityProperties<TContext>(
  options: {
    mutation?: UseMutationOptions<
      ...
      ResponseErrorConfig<UpsertIdentityProperties422>,
      { identity_id: UpsertIdentityPropertiesPathParams['identity_id']; data?: UpsertIdentityPropertiesMutationRequest },
      TContext
    > & { client?: QueryClient }
    client?: Partial<RequestConfig<UpsertIdentityPropertiesMutationRequest>> & { client?: typeof client }
  } = {},
) {
