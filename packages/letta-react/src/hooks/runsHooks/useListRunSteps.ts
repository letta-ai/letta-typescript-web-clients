...
export const listRunStepsQueryKey = (run_id: ListRunStepsPathParams['run_id'], params?: ListRunStepsQueryParams) =>
...
>(
  ...
  params?: ListRunStepsQueryParams,
  options: {
    query?: Partial<QueryObserverOptions<ResponseConfig<ListRunStepsQueryResponse>, ResponseErrorConfig<ListRunSteps422>, TData, TQueryData, TQueryKey>> & {
      client?: QueryClient
    }
  ...
  const queryKey = queryOptions?.queryKey ?? listRunStepsQueryKey(run_id, params)

  const query = useQuery(
    {
      ...(listRunStepsQueryOptions(run_id, params, config) as unknown as QueryObserverOptions),
      queryKey,
      ...(queryOptions as unknown as Omit<QueryObserverOptions, 'queryKey'>),
    },
    queryClient,
  ) as UseQueryResult<TData, ResponseErrorConfig<ListRunSteps422>> & { queryKey: TQueryKey }
